...
MAKEFILE = closestPoint_mex_mex.mk

include closestPoint_mex_mex.mki


SRC_FILES =  \
	closestPoint_mex_data.c \
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\closestPoint_mex"
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\closestPoint_mex\interface"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\closestPoint_mex/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\closestPoint_mex/%.cpp
	$(CC) $(CPPFLAGS) "$<"
