...
MAKEFILE = dummy_mex.mk

include dummy_mex.mki
...
MEX_FILE_NAME_WO_EXT = dummy_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/dummy"
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/dummy/interface"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/dummy/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/dummy/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/dummy/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
