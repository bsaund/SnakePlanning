START_DIR = C:\Users\Brad\DOCUME~1\Work\CMU\SNAKEP~1\_CONTA~1

MATLAB_ROOT = C:\PROGRA~1\MATLAB\R2015a
MAKEFILE = closestPoint_mex.mk

include closestPoint_mex.mki
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\closestPoint"
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\closestPoint\interface"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\closestPoint/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\closestPoint/%.cpp
	$(CC) $(CPPFLAGS) "$<"
